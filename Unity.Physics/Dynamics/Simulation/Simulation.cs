...
namespace Unity.Physics
{
    ...
    public struct Simulation : ISimulation
    {
        ...
        public SimulationJobHandles ScheduleSolveAndIntegrateJobs(SimulationStepInput input, JobHandle inputDeps, bool multiThreaded = true)
        {
            ...
            // Note: VoxelContactDataStream is already constructed with the same work item count in
            // NarrowPhase.ScheduleCreateContactsJobs, since voxel contacts are written during contact creation.
